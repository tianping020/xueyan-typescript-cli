...
const scriptFilePattern = /\.(js|mjs|jsx|ts|tsx)$/

const defineFilePattern = /\.d\.(ts|tsx)$/

const testFilePattern = /\.test\.(js|mjs|jsx|ts|tsx)$/
...
export default class ProjectBuilder {
   ...
   * 项目信息
   */
  readonly project: ReactPackageProject
